...
export class CommentService {
  ...
  likeComment(comment: Comment) {
    return this.http.post(environment.baseApiUrl + '/like-comment', {comment: comment}, {headers: this.headers});
  }

  unlikeComment(comment: Comment) {
    return this.http.delete(environment.baseApiUrl + '/unlike-comment/' + comment.id, {headers: this.headers});
  }
}
